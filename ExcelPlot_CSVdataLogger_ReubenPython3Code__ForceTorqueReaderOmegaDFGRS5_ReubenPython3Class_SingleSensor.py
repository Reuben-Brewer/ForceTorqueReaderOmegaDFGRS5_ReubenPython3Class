...
Verified working on: Python 3.8 for Windows 10/11 64-bit.
'''
...
def CreateExcelChart(FileName_to_save_full_path, DataOrderedDictToWrite):
    ...
    SumOfForceDerivativesFromAllSensors_ExcelColumnLetter = "D"

    ForceDerivative0_ExcelColumnLetter = "E"
...
if __name__ == '__main__':
    ...
    #########################################################
    print("$$$$$$$$$$$$$$$$")
    print("RUN THIS PROGRAM FROM COMMAND LINE LIKE THIS: 'python ExcelPlot_CSVdataLogger_ReubenPython3Code__ForceTorqueReaderOmegaDFGRS5_ReubenPython3Class_.py CSV-FILE-DIRECTORY-FULL-PATH'")
    print("$$$$$$$$$$$$$$$$")
    #########################################################
