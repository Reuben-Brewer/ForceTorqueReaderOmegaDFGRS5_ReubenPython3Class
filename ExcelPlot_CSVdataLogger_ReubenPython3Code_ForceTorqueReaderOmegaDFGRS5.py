...
def CreateExcelChart(FileName_to_save_full_path, DataOrderedDictToWrite):
    ...
    try:
        ...
        CSVdataLogger_VariableNamesForHeaderList = ['Time (S)', 'SumOfForcesFromAllSensors (N)', 'Force 0 (N)', 'SumOfForceDerivativesFromAllSensors (N/s)', 'ForceDerivative 0 (N/s)', 'SumOfTorquesFromAllSensors (Nm)', 'Torque 0 (Nm)', 'SumOfTorqueDerivativesFromAllSensors (Nm/s)', 'TorqueDerivative 0 (Nm/s)']
        ...
        ##########################################################################################################
        ##########################################################################################################
        VariableNamesListToInludeOnSinglePlotVsTime = ["SumOfForcesFromAllSensors (N)"]
        ...
        ##########################################################################################################
        ##########################################################################################################
        VariableNamesListToInludeOnSinglePlotVsTime = ["SumOfTorquesFromAllSensors (Nm)"]
